...
public final class DeleteMetricsSessingsForTickerMutation: GraphQLMutation {
  /// The raw GraphQL definition of this operation.
  public let operationDefinition: String =
    """
    mutation DeleteMetricsSessingsForTicker($profileID: Int!) {
      delete_app_profile_ticker_metrics_settings(
        where: {collection_id: {_is_null: true}, profile_id: {_eq: $profileID}}
      ) {
        __typename
        returning {
          __typename
  ...
  public let operationName: String = "DeleteMetricsSessingsForTicker"
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public static var selections: [GraphQLSelection] {
      return [
        GraphQLField("delete_app_profile_ticker_metrics_settings", arguments: ["where": ["collection_id": ["_is_null": true], "profile_id": ["_eq": GraphQLVariable("profileID")]]], type: .object(DeleteAppProfileTickerMetricsSetting.selections)),
      ]
    }
