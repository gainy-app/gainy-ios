...
public final class InsertMetricsSessingsForTickerMutation: GraphQLMutation {
  /// The raw GraphQL definition of this operation.
  public let operationDefinition: String =
    """
    mutation InsertMetricsSessingsForTicker($profileID: Int!, $f1: String!, $f2: String!, $f3: String!, $f4: String!, $f5: String!, $f6: String!) {
      insert_app_profile_ticker_metrics_settings(
        objects: [{profile_id: $profileID, field_name: $f1, order: 0}, {profile_id: $profileID, field_name: $f2, order: 1}, {profile_id: $profileID, field_name: $f3, order: 2}, {profile_id: $profileID, field_name: $f4, order: 3}, {profile_id: $profileID, field_name: $f5, order: 4}, {profile_id: $profileID, field_name: $f6, order: 5}]
      ) {
        __typename
        returning {
          __typename
  ...
  public let operationName: String = "InsertMetricsSessingsForTicker"
  ...
  public init(profileID: Int, f1: String, f2: String, f3: String, f4: String, f5: String, f6: String) {
  ...
  public var variables: GraphQLMap? {
    return ["profileID": profileID, "f1": f1, "f2": f2, "f3": f3, "f4": f4, "f5": f5, "f6": f6]
  }
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public static var selections: [GraphQLSelection] {
      return [
        GraphQLField("insert_app_profile_ticker_metrics_settings", arguments: ["objects": [["profile_id": GraphQLVariable("profileID"), "field_name": GraphQLVariable("f1"), "order": 0], ["profile_id": GraphQLVariable("profileID"), "field_name": GraphQLVariable("f2"), "order": 1], ["profile_id": GraphQLVariable("profileID"), "field_name": GraphQLVariable("f3"), "order": 2], ["profile_id": GraphQLVariable("profileID"), "field_name": GraphQLVariable("f4"), "order": 3], ["profile_id": GraphQLVariable("profileID"), "field_name": GraphQLVariable("f5"), "order": 4], ["profile_id": GraphQLVariable("profileID"), "field_name": GraphQLVariable("f6"), "order": 5]]], type: .object(InsertAppProfileTickerMetricsSetting.selections)),
      ]
    }
