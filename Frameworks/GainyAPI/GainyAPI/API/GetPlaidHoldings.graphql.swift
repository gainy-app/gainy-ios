...
public final class GetPlaidHoldingsQuery: GraphQLQuery {
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    /// fetch data from the table: "public_230111122944.portfolio_gains"
    ...
    /// fetch data from the table: "public_230111122944.profile_holding_groups"
    ...
    public struct ProfileHoldingGroup: GraphQLSelectionSet {
      ...
      public struct Holding: GraphQLSelectionSet {
        ...
        public init(accountId: Int? = nil, holdingId: Int? = nil, name: String? = nil, quantity: float8? = nil, tickerSymbol: String? = nil, type: String? = nil, broker: Broker? = nil, holdingDetails: HoldingDetail? = nil, gains: Gain? = nil) {
