...
public final class UpdateProfileScoringSettingsWithInterestsPart1Mutation: GraphQLMutation {
  /// The raw GraphQL definition of this operation.
  public let operationDefinition: String =
    """
    mutation UpdateProfileScoringSettingsWithInterestsPart1($profileID: Int!, $averageMarketReturn: Int!, $damageOfFailure: Float!, $marketLoss20: Float!, $marketLoss40: Float!, $investemtHorizon: Float!, $riskLevel: Float!, $stockMarketRiskLevel: String!, $tradingExperience: String!, $unexpectedPurchaseSource: String!) {
  ...
  public let operationName: String = "UpdateProfileScoringSettingsWithInterestsPart1"
