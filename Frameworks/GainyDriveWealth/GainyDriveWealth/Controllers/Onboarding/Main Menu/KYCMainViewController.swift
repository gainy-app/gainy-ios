    ...
    private func setupDisclosures() {
        ...
        if let attributedString: NSAttributedString = privacyPolicyTextView.attributedText {
            ...
            if let mutableAttributedString = attributedString.mutableCopy() as? NSMutableAttributedString {
                ...
                mutableAttributedString.setAsLink(textToFind: "Gainy Agreements", linkURL: "https://www.gainy.app/legal-hub/client-agreement")
                mutableAttributedString.setAsLink(textToFind: "Form CRS", linkURL: "https://www.gainy.app/legal-hub/form-crs")
                mutableAttributedString.setAsLink(textToFind: "Form ADV Part 2", linkURL: "https://www.gainy.app/legal-hub/form-adv2a")
