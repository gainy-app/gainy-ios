...
public final class GetTickersForCollectionQuery: GraphQLQuery {
  ...
  public let operationName: String = "GetTickersForCollection"
  ...
  public var orderBy: [ticker_collections_order_by]?

  public init(collectionId: Int, offset: Int, orderBy: [ticker_collections_order_by]?) {
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public static var selections: [GraphQLSelection] {
      return [
        GraphQLField("ticker_collections", arguments: ["where": ["collection_id": ["_eq": GraphQLVariable("collectionId")]], "order_by": GraphQLVariable("orderBy"), "limit": 20, "offset": GraphQLVariable("offset")], type: .nonNull(.list(.nonNull(.object(TickerCollection.selections))))),
      ]
    }
