...
public final class FetchStockMedianMonthQuery: GraphQLQuery {
  /// The raw GraphQL definition of this operation.
  public let operationDefinition: String =
    """
    query FetchStockMedianMonth($symbol: String!, $date: timestamp!) {
  ...
  public let operationName: String = "FetchStockMedianMonth"
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    /// fetch data from the table: "public_220330042711.tickers"
      ...
      public struct TickerIndustry: GraphQLSelectionSet {
        ...
        public struct GainyIndustry: GraphQLSelectionSet {
          ...
          public static var selections: [GraphQLSelection] {
            return [
              GraphQLField("__typename", type: .nonNull(.scalar(String.self))),
              GraphQLField("ticker_industry_median_1m", arguments: ["where": ["date": ["_gte": GraphQLVariable("date")]]], type: .nonNull(.list(.nonNull(.object(TickerIndustryMedian_1m.selections))))),
            ]
          }
          ...
          public init(tickerIndustryMedian_1m: [TickerIndustryMedian_1m]) {
            self.init(unsafeResultMap: ["__typename": "gainy_industries", "ticker_industry_median_1m": tickerIndustryMedian_1m.map { (value: TickerIndustryMedian_1m) -> ResultMap in value.resultMap }])
          }
          ...
          public struct TickerIndustryMedian_1m: GraphQLSelectionSet {
            ...
            public init(medianPrice: float8? = nil, date: timestamp? = nil) {
              self.init(unsafeResultMap: ["__typename": "industry_median_1m", "median_price": medianPrice, "date": date])
            }
