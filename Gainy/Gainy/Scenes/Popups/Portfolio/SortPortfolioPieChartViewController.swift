...
protocol SortPortfolioPieChartViewControllerDelegate: AnyObject {
    func selectionChanged(vc: SortPortfolioPieChartViewController, sorting: PortfolioSortingField, ascending: Bool)
}

final class SortPortfolioPieChartViewController: BaseViewController {

    weak var delegate: SortPortfolioPieChartViewControllerDelegate?
    ...
    private func btnsMapping() ->  [PortfolioSortingField: Int]  {
        ...
        let defaultSortingList = PortfolioSortingField.othersRawOrder
