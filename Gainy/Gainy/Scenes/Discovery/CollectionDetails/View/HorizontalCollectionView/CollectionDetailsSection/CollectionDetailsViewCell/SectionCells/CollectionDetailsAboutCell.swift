...
final class CollectionDetailsAboutCell: UICollectionViewCell {
    ...
    override init(frame _: CGRect) {
        ...
        aboutLabel.autoPinEdge(toSuperviewEdge: .left, withInset: 24.0)
        aboutLabel.autoPinEdge(toSuperviewEdge: .top, withInset: 24)
        aboutLabel.autoSetDimension(.height, toSize: 24.0)
        
        detailsLbl.autoPinEdge(toSuperviewEdge: .left, withInset: 24.0)
